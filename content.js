(function() {
    ...
    */
    ...
    var scrollingClasses = ["stop-scrolling", "tp-modal-open", "overflow_hidden", "adblock-on", "swal2-shown"];
    ...
    var adblockta = async function() {
        ...
        try {
            for (var i in document.getElementsByTagName("iframe")) {
                ...
                if (theframe.style && theframe.style.cssText.includes("!important; opacity: 1 !important; max-width: 100% !important; border: 0px !important; position: fixed !important; display: block !important; z-index: 2147483647 !important; inset")) {
                    theframe.remove();
                }
            ...
            for (var i in document.getElementsByTagName("div")) {
                ...
                if (thediv.id) {
                    ...
                    if (thediv.id.includes("google_ads_iframe") || thediv.id.includes("superbannerWrapper") || thediv.id.includes("banner-ad") || thediv.id.includes("topad") || thediv.id.includes("adRootContainer") || thediv.id.includes("advertising") || thediv.id.includes("div-gpt-ad")) {
                        thediv.remove();
                    }
     ...
     || (thediv.dataset.componentRoot && thediv.dataset.componentRoot.toLowerCase() === "leaderboardad"))) {
                    ...
                    if (Array.isArray(clas)) {
                        ...
                        if (clas2 === "*" || window.location.host.includes(clas2) || (clas2.startsWith("!") && !window.location.host.startsWith(clas2.slice(1)))) {
                            for (var i in document.getElementsByClassName(clas)) {
                                if (document.getElementsByClassName(clas) && document.getElementsByClassName(clas)[i] && document.getElementsByClassName(clas)[i] instanceof HTMLElement) {
                                    if (clas3) {
                                        ...
                                        var elem = document.getElementsByClassName(clas)[i];
            ...
            if (window.location.host.includes("nytimes.com")) {
                ...
                if (document.getElementById("site-content") && document.getElementById("site-content").style.cssText.includes("position: fixed;")) {
                    document.getElementById("site-content").style.cssText = document.getElementById("site-content").style.cssText.replace("position: fixed;", "")
                }
            }
